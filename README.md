...
最新の公開版は `0.39.1` です。この保守版では、動作仕様を維持したまま
TypeScript の厳密な null 検査、ESLint 警告の解消、Obsidian 公開 API との型整合、
開発用依存関係と Canvas 読み込みの安全性を改善しています。
...
The latest release is `0.39.1`. This maintenance release adds strict null
checking, removes ESLint warnings, aligns types with Obsidian's public API, and
improves development-tool and Canvas-loading safety while preserving existing
behavior.
